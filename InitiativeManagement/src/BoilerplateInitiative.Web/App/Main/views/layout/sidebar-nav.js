    ...
    angular.module('app').controller(controllerId, [
        ...
        function ($rootScope, $state, appSession) {
            ...
            vm.menuItems = [
                ...
                createMenuItem(App.localize("Initiatives"), "Pages.Initiatives", "info", "initiatives"),
                createMenuItem(App.localize("FieldGroups"), "Pages.FieldGroups", "info", "fieldgroups"),
                createMenuItem(App.localize("Fields"), "Pages.Fields", "info", "fields"),
