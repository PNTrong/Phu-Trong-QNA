...
using BoilerplateInitiative.Sessions;
using BoilerplateInitiative.Web.Controllers.Results;
using BoilerplateInitiative.Web.Models;
using BoilerplateInitiative.Web.Models.Account;
...
{
    public class AccountController : BoilerplateInitiativeControllerBase
    {
